...
#ifndef PROJECT_LASTWORDINTHEFIRSTLINETHATISINTHESECONDLINE_H
#define PROJECT_LASTWORDINTHEFIRSTLINETHATISINTHESECONDLINE_H

WordDescriptor lastWordInTheFirstStringThatISInTheSecondString(char *s1, char *s2) {
    BagOfWords bag1;
...
#endif //PROJECT_LASTWORDINTHEFIRSTLINETHATISINTHESECONDLINE_H
